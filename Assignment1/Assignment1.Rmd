...
New data frame that stores information merged from both of the analyzed datasets. 
...
Creating a new dataframe that will show incidence rate among both sexes in each year.
